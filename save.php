...
if(isset($_POST['save'])){
    $event_img_cover  = $_POST['event_img_cover'];
    $event_img_logo   = $_POST['event_img_logo'];
...
// $ext1 = pathinfo(basename($_FILES['event_img_logo']['name']), PATHINFO_EXTENSION);
// $new_img_name1='img_'.uniqid().".".$ext1;
// $img_path1 ="images/";
// $upload_path1 = $img_path1.$new_img_name1;
// $success1 = move_uploaded_file($_FILES['event_img_logo']['tmp_name'],$upload_path1);
// if($success1==false){
...
// }
    ...
    $sql = "INSERT INTO events ( event_img_cover,event_img_cover, event_title,    event_desc,   event_category,   event_date_start,   event_date_end,   event_location)
